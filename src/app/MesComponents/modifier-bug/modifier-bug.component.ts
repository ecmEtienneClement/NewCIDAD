...
@Component({
  selector: 'app-modifier-bug',
  templateUrl: './modifier-bug.component.html',
  styleUrls: ['./modifier-bug.component.css'],
})
export class ModifierBugComponent implements OnInit {
